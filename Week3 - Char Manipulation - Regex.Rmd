---
title: "Week3 Assignment - Character Manipulation - Regex"
author: "humbertohp"
date: "September 14, 2018"
output: html_document
---

# Load Raw Data and Extract Names
```{r echo=TRUE}
library(stringr)
...
## 5. <(.+?)>.+?\\1 - Extracts the first string enclosed by "<>" then extracts the next occurrence of that substring regardless of what is in between
```{r echo=TRUE}
